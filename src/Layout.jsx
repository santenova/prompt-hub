...
import { Sparkles, Menu, LogOut, Search, FileText, Users } from 'lucide-react';
...
export default function Layout({ children, currentPageName }) {
  ...
  const isChatPage = currentPageName === 'Chat' || location.pathname.toLowerCase().includes('/chat');
  const isFullscreenPage = currentPageName === 'AIContentGenerator' || isVoicePage || isChatPage;
              ...
              <div className="hidden lg:flex items-center gap-2">
                ...
                {!currentUser && (
                  <>
                    ...
                    >
                      <Button 
                        onClick={() => client.auth.redirectToLogin()} 
