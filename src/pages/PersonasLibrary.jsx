...
export default function PersonasLibrary() {
  ...
  const { data: prompts = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const data = await client.entities.Template.list();
        return Array.isArray(data) ? data : [];
      } catch (error) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-white/80 backdrop-blur-lg border-b border-purple-100 sticky top-16 sm:top-[4.5rem] z-40 overflow-hidden">
