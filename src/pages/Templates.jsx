...
export default function Templates() {
  ...
  const { data: allTemplates = [], isLoading, dataUpdatedAt, isRefetching } = useQuery({
    queryKey: ['templates'],
    queryFn: async () => {
      try {
        ...
        const data = await apiClient.entities.Template.list('-created_date');
  ...
  const createTemplateMutation = useMutation({
    mutationFn: async (data) => {
      ...
      return apiClient.entities.Template.create(data);
    },
    onSuccess: () => {
      queryClient.invalidateQueries(['templates']);
  ...
  const updateTemplateMutation = useMutation({
    mutationFn: async ({ id, data }) => {
      ...
      return apiClient.entities.Template.update(id, data);
    },
    onSuccess: () => {
      queryClient.invalidateQueries(['templates']);
    },
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <CollaborationStatus 
                  ...
                  onRefresh={() => queryClient.invalidateQueries(['templates'])}
                />
              </div>
            </div>
            {currentUser && (
