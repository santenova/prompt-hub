...
import PersonaAISuggester from "./PersonaAISuggester";
import PersonaVoiceTuner from "./PersonaVoiceTuner";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <Tabs value={aiTab} onValueChange={setAiTab}>
              ...
              <TabsContent value="ai-tags" className="mt-4">
                <AutoTagSuggester
                  content={`${formData.name} - ${formData.description} - ${formData.instructions}`}
                  title={formData.name}
          ...
          <div className="space-y-4">
            <PersonaAISuggester
              ...
              onApplyExpertise={handleApplyExpertise}
              onApplyExamples={handleApplyExamples}
            />
            ...
            <PersonaVoiceTuner
              ...
              expertiseAreas={formData.expertise_areas}
              currentTone={formData.tone}
              onApplyVoiceProfile={handleApplyVoiceProfile}
            />
          </div>
        </div>
      </DialogContent>
